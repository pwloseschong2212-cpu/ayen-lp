...
function Hero({ videoOn }) {
  return (
    <section style={{
      position: 'relative', height: 'calc(var(--app-vh, 1svh) * 100)', minHeight: 680,
...
function Leak() {
  ...
  return (
    <section ref={sectionRef} data-funnel-section style={{
      position: 'relative', height: 'calc(var(--app-vh, 1svh) * 100)', minHeight: 600,
      width: '100%', overflow: 'hidden',
      background: 'var(--bg)'
    }}>
      <video
...
function Belief() {
  return (
    <section className="pad-y-xl" style={{
      minHeight: 'calc(var(--app-vh, 1svh) * 100)',
...
function Contact() {
  return (
    <section id="contact" className="pad-y-xl" style={{
      position: 'relative', minHeight: 'calc(var(--app-vh, 1svh) * 100)',
      display: 'flex', flexDirection: 'column', justifyContent: 'center',
      overflow: 'hidden'
    }}>
      {/* ambient glow */}
